...
def main():
    ...
    p.add_argument("--version", choices="0.5 0.6 0.7 ddnet-15.2.5 ddnet-16.2 ddnet-16.7.2 ddnet-17.2.1 ddnet-19.1 none".split(), help="Force version for fixup instead of heuristically guessing a version")
