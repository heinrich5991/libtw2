...
pub trait HashMapEntryIntoInner<'a> {
    type Key;
    type Value;
    fn into_occupied(self) -> Option<hash_map::OccupiedEntry<'a,<Self as HashMapEntryIntoInner<'a>>::Key,<Self as HashMapEntryIntoInner<'a>>::Value>>;
    fn into_vacant(self) -> Option<hash_map::VacantEntry<'a,<Self as HashMapEntryIntoInner<'a>>::Key,<Self as HashMapEntryIntoInner<'a>>::Value>>;
}
