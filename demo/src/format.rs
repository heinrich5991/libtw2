...
impl TimelineMarkersPacked {
    pub fn unpack<W: Warn<Warning>>(&self, warn: &mut W) -> Result<TimelineMarkers, Error> {
        let num = self
            .num_timeline_markers
            .to_i32()
            .try_u32()
            .ok_or(Error::InvalidNumTimelineMarkers)?
            .usize();
...
impl ChunkHeaderStartPacked {
    pub fn unpack<W: Warn<Warning>>(self, warn: &mut W, version: Version) -> ChunkHeaderStart {
